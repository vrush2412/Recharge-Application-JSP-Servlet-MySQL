...
<body style="background: #0088a9">
	...
	<form action="Display_PlanController" >		
     ...
     <% for(Operator op : lstop)
     {
    	%>  <tbody class="text-centre">
    	 <tr>
			...
			<td class="table-success"><a href="User_Register.jsp"><%=op.getPrice()%> </a></td>
			<td><a href="User_Register.jsp"><input type="submit" value="Recharge Now"> </a></td>
      </tr>
        </tbody>
    	<%} %>
    	<%} %>	
