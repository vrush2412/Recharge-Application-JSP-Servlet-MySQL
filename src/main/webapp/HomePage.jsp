...
<body>
	...
	<div id="Home">
		<ul class="menu cf">
			...
			<li><a href="User_Register.jsp">Product & Services</a>
				<ul class="submenu">
					<br>
					<br>
					<li><a href="User_Register.jsp">Send Money</a></li>
					<li><a href="User_Register.jsp">Mobile Recharge</a></li>
					<li><a href="User_Register.jsp">TV Recharge</a></li>

				</ul></li>

			<li><a href="#About">About Us</a></li>
			<li><a href="#contact">Contact Us</a></li>
			<li><a href="User_Register.jsp">Login</a></li>
		</ul>
	</div>
	<!-- About Us START -->
				...
				<div class="row">
					...
					<div class="content">
						<div class="info">
							...
							<p>
								<b>Search over 69,000 local Professionals</b><br>
								<b>with reviews,pricing and </b><br>
								<b>many more</b><br>
								<br> <a href="User_Register.jsp" class="info-btn"><b>Get
										Started</b></a> <a href="UserViewLoginController" class="info-btn"><b>View
										Plans</b></a>
						</div>
					</div>
